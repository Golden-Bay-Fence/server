...
<?php }?>
	...
	if(strpos($agent, 'GBFUSER') !== false) { ?>
<script>
document.getElementsById('uiminibt').item(0).addEventListener('click', () => windowControls.minimize())
document.getElementsById('uimaxbt').item(0).addEventListener('click', () => windowControls.maximize())
document.getElementsById('uiclsbt').item(0).addEventListener('click', () => windowControls.close())
</script>
<?php } ?>
</body>
</html>
